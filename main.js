...
/*Добавьте в функцию еще один параметр, который отражал бы выбранный период заселения (например, checkInDate и checkOutDate);
Доработайте вашу функцию таким образом, чтобы она возвращала двумерный массив объектов (числа должны быть заменены на объекты), которые будут иметь след. вид:
{
    dayOfMonth: 28, // required field - день месяца
        notCurrentMonth: true, // optional field - день не входит в текущий месяц
    selectedDay: true, // optional field - выбранный пользователем день
}*/
